    ...
    $shop_data="SELECT * FROM tm_shopinfo ";
  ...
  $admin_data="SELECT user_id,user_fullname,profile_img FROM tm_user where user_id=1";
    ...
    <head>
        <meta charset="UTF-8" />
        <title>Store Finder | Shops</title>
...
<li class="panel ">
    ...
    if($shop_result->num_rows > 0)
    {
        while($row=$shop_result->fetch_assoc()){
            ...
            $user_data="SELECT user_fullname from tm_user where user_id=$shopkeeper_id";
            ...
            $Otime=strtotime($Otime);
                ...
                $Closetime=date("h:ia",$Ctime);
                                        ...
                                        echo"
                                                <tr class='odd gradeX'>
                                                <td> <a href='details.php?shop=$shop_id'>$title</a></td>
                                                <td>$location</td>
                                                <td>$fullname</td>
                                                <td>$description</td>
                                                <td class='center'><img src='uploads/shop_img/{$image}' width='50'></td>
                                                <td class='center'>$category</td>
                                                <td class='center'>$Opentime</td>
                                                <td class='center'>$Closetime</td>
                                                <td>$weekday</td>
                                                <td class='center'>$view</td>
                                                <td><a href='admin_shop_delete.php?shop=$shop_id' class='btn btn-sm btn-danger my-1 '  onclick='Deleteshop(event)'>Delete</a></td>
                                            </tr>
